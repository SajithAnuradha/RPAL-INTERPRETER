        ...
        if (!this.isStandardized) {
            ...
            switch (this.getData()) {
                ...
                case "function_form":
                    ...
                    Node currentLambda = NodeFactory.getNode("lambda", this.depth + 1, this, new ArrayList<Node>(),
                            true);
                    ...
                    while (!this.children.get(2).equals(Ex)) {
                        ...
                        if (this.children.size() > 3) {
                            currentLambda = NodeFactory.getNode("lambda", currentLambda.depth + 1, currentLambda,
                ...
                case "lambda":
                    if (this.children.size() > 2) {
                        ...
                        Node currentLambdax = NodeFactory.getNode("lambda", this.depth + 1, this, new ArrayList<Node>(),
                                true);
                        ...
                        while (!this.children.get(2).equals(Ey)) {
                            ...
                            if (this.children.size() > 3) {
                                currentLambdax = NodeFactory.getNode("lambda", currentLambdax.depth + 1, currentLambdax,
                                        new ArrayList<Node>(), true);
